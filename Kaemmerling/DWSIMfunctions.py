...
def Heat_exchanger1(temperature_inlet1, pressure_inlet1, temperature_inlet2, pressure_inlet2, compoundscompoundflow, compoundscompoundflow2, heat_exchange_area, global_heat_transfer):
...
def Tank1(temperature, pressure, compoundscompoundflow, tank_volume):
...
def Separator1(temperature, pressure, compoundscompoundflow):
...
def Pump1(temperature, pressure, compoundscompoundflow, outletpressure, pressureincrease, energystream, powerrequired):
...
def PFR1(temperature, pressure, compoundscompoundflow, isothermic, adiabatic, outlet_temperature, base_compound, direct_order, reverse_order, stochiometry, reactor_diameter, reactor_length, reactor_volume, arrhenius_parameter):
...
def CSTR1(temperature, pressure, compoundscompoundflow, isothermic, adiabatic, outlet_temperature, base_compound, direct_order, reverse_order, stochiometry,reactor_volume, arrhenius_parameter):
...
def Column1(temperature, pressure, compoundscompoundflow, lk_mole_fraction_in_distillate, hk_mole_fraction_in_distillate, reflux_ratio, light_key_compound, heavy_key_compound):

# -*- coding: utf-8 -*-
"""
Created on Tue May 24 23:12:19 2022
...
co1 = sim.AddObject(ObjectType.Cooler, 100, 50, "cooler")

sim.ConnectObjects(m1.GraphicObject, co1.GraphicObject, -1, -1)
sim.ConnectObjects(co1.GraphicObject, m2.GraphicObject, -1, -1)
sim.ConnectObjects(co1.GraphicObject, e1.GraphicObject, -1, -1)
...
m1.SetTemperature(400.0) # K
m1.SetMassFlow(100.0) # kg/s

# set heater outlet temperature

co1.CalcMode = UnitOperations.Cooler.CalculationMode.OutletTemperature
co1.OutletTemperature = 300 # K
...
deltat = co1.DeltaT
heat_flow = e1.EnergyFlow

# ERROR: gibt keinen heatflow aus

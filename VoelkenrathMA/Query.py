...
def query_1(molefrac_co2, temperature, pressure, velocity, downstream):
    ...
    # e.g.: results = Query.query_1(0.5, 273.0, 100000.0, 0.001, "'Yes'")
    sparqlstr = """
...
def query_2(molefrac_co2=None, temperature=None, pressure=None, velocity=None, downstream=None):
    ...
    # e.g.: results = Query.query_2(molefrac_co2=0.5, temperature=273.0)
    # e.g.: results = Query.query_2(pressure=10000.0)
    sparqlstr = """
    PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    PREFIX owl: <http://www.w3.org/2002/07/owl#>
    PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
...
def query_3(molefrac_co2=None, temperature=None, pressure=None, velocity=None):
    ...
    # e.g.: results = Query.query_3(molefrac_co2=0.3, temperature=300.0)
    sparqlstr = """
    PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    PREFIX owl: <http://www.w3.org/2002/07/owl#>
    PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
...
def query_4(x_co2):
    # Query for some unspecific parameter
    # e.g.: results = Query.query_4(x_co2 = 0.2)
    sparqlstr = """
    PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    PREFIX owl: <http://www.w3.org/2002/07/owl#>
    PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>

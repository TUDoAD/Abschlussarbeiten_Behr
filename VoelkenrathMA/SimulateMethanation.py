...
def simulation(name, data):
    ...
    catLoading = 1000 # ACHTUNG: Bei der Datengenerierung variabel halten um Daten zu generieren
    r1.CatalystLoading = 1000.0
...
def run(name):
    with open("C:/Users/smmcvoel/Documents/GitHub/Abschlussarbeiten_Behr/VoelkenrathMA/linkml/New_Reaction_02_DataSheet.yaml", "r") as file:

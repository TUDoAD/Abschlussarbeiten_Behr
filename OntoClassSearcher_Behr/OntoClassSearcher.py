...
def onto_class_comparison(desc_list_dict, file_name, new_file_name):
    ...
    set_1 = [iter_string.lower() for iter_string in list(concept_table[1])]
    ...
    for i in range(len(onto_names)):
        ...
        print("Found {}/{} common concept names for Ontology {} and pdf-Data".format(len(candidates),len(set_1),onto_names[i]))

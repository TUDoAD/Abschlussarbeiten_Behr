...
from Test_for_adding_classes_to_ontology_functions_3 import *
import translator_list_json_to_onto_2
import translator_list_json_to_onto_3_test as translator_3
import copy
...
list_of_keys_containing_named_instances = translator_3.list_of_keys_containing_named_instances
list_of_keys_containing_named_sub_instances = translator_3.list_of_keys_containing_named_sub_instances
list_of_keys_containing_named_sub_sub_instances = translator_3.list_of_keys_containing_named_sub_sub_instances
list_of_keys_containing_named_sub_sub_sub_instances = translator_3.list_of_keys_containing_named_sub_sub_sub_instances
list_of_instance_keys = translator_3.list_of_instance_keys
list_of_instance_sub_keys = translator_3.list_of_instance_sub_keys
list_of_keys_containing_non_named_sub_instances_in_named_instances = translator_3.list_of_keys_containing_non_named_sub_instances_in_named_instances
list_of_keys_containing_non_named_sub_sub_instances_in_named_instances = translator_3.list_of_keys_containing_non_named_sub_sub_instances_in_named_instances
...
for name in os.listdir('C:/Users/hendr/Documents/GitHub/Hendrik_Borgelt_Masterthesis/Json_Dict_unmodified2'):
    if name.endswith(".json"):
        with open('./Json_Dict_unmodified2/' + name) as outfile:
            all_sims.update({name.rstrip('.json'): json.load(outfile)})

change_filepath_name_in_dict(all_sims)


dict_of_key_sections = {
...
Path_3 = 'C:/Users/hendr/Documents/GitHub/Hendrik_Borgelt_Masterthesis/Translator_test_modified - Kopie.xlsx'
...
emmo = modify_ontologiy_by_adding_classes(dict_of_excel_translator, emmo)
time_2 = time.process_time()
print('implementing Classes time', time_2 - time_1)

test_dict_for_translator = copy.deepcopy(all_sims)
search_for_name_option_in_dict(test_dict_for_translator)
list_of_keys_int = list_of_keys_containing_named_sub_sub_sub_instances + \
...
list_of_keys_containing_named_instances_2 = translator_3.list_of_keys_containing_named_instances
list_of_keys_containing_named_sub_instances_2 = translator_3.list_of_keys_containing_named_sub_instances
list_of_keys_containing_named_sub_sub_instances_2 = translator_3.list_of_keys_containing_named_sub_sub_instances
list_of_keys_containing_named_sub_sub_sub_instances_2 = translator_3.list_of_keys_containing_named_sub_sub_sub_instances
list_of_instance_keys_2 = translator_3.list_of_instance_keys
list_of_instance_sub_keys_2 = translator_3.list_of_instance_sub_keys
list_of_keys_containing_non_named_sub_instances_in_named_instances_2 = translator_3.list_of_keys_containing_non_named_sub_instances_in_named_instances
list_of_keys_containing_non_named_sub_sub_instances_in_named_instances_2 = translator_3.list_of_keys_containing_non_named_sub_sub_instances_in_named_instances

tuple_list_of_named_inst = list_of_keys_containing_named_sub_sub_sub_instances_2 + \
                           list_of_keys_containing_named_sub_sub_instances_2 + \
                           list_of_keys_containing_named_sub_instances_2 + \
                           list_of_keys_containing_named_instances_2

tuple_list_of_non_named_inst = list_of_instance_sub_keys_2 + \
                               list_of_instance_keys_2 + \
                               list_of_keys_containing_non_named_sub_instances_in_named_instances_2 + \
                               list_of_keys_containing_non_named_sub_sub_instances_in_named_instances_2

# test_1 = change_list_of_tuples_to_list_of_str(list_of_keys_containing_named_sub_sub_sub_instances_2)

dict_for_inst_separation = copy.deepcopy(all_sims)
merged_dict_for_inst_separation = create_merged_dict(dict_for_inst_separation)

# test_2 = new_dicts_to_individualdicts(merged_dict_for_inst_separation,
#                                       list_of_keys_containing_named_sub_sub_sub_instances_2,
#                                       tuple_list_of_named_inst,
#                                       tuple_list_of_non_named_inst)
path_test = './dict_inst_3/named_sss_inst/'

# test_3 = search_for_name_in_outdict_and_save(all_sims, test_2, path_test)


# sub_sub_sub_dict_folder_path = 'C:/Users/hendr/Documents/GitHub/Hendrik_Borgelt_Masterthesis/dict_inst_3/named_sss_inst/'
# new_dict_all_sims_sub_sub_sub = change_name_of_sub_sub_inst_2(dict_for_inst_separation, path_test, tuple_list_of_non_named_inst)

new_dict_for_inst_separation = copy.deepcopy(all_sims)
# new_dict_all_sims_sub_sub_sub = find_rename_and_replace_inst_dict(new_dict_for_inst_separation,
#                                                                   list_of_keys_containing_named_sub_sub_sub_instances_2,
#                                                                   tuple_list_of_named_inst,
#                                                                   tuple_list_of_non_named_inst,
#                                                                   path_test)
...
dict_for_instance_renaming = OrderedDict({
    'named_sub_sub_sub_inst': {'list_instances_tbc': list_of_keys_containing_named_sub_sub_sub_instances_2,
                               'path': './dict_inst_all_data/named_sub_sub_sub_inst/'},
    'non_named_sub_sub_inst': {
        'list_instances_tbc': list_of_keys_containing_non_named_sub_sub_instances_in_named_instances_2,
        'path': './dict_inst_all_data/non_named_sub_sub_inst/'},
    'named_sub_sub_inst': {'list_instances_tbc': list_of_keys_containing_named_sub_sub_instances_2,
                           'path': './dict_inst_all_data/named_sub_sub_inst/'},
    'non_named_sub_inst': {'list_instances_tbc': list_of_keys_containing_non_named_sub_instances_in_named_instances_2,
                           'path': './dict_inst_all_data/non_named_sub_inst/'},
    'named_sub_inst': {'list_instances_tbc': list_of_keys_containing_named_sub_instances_2,
                       'path': './dict_inst_all_data/named_sub_inst/'},
    'named_inst': {'list_instances_tbc': list_of_keys_containing_named_instances_2,
                   'path': './dict_inst_all_data/named_inst/'},
    'sub_inst': {'list_instances_tbc': list_of_instance_sub_keys_2,
                 'path': './dict_inst_all_data/sub_inst/'},
    'inst': {'list_instances_tbc': list_of_instance_keys_2,
             'path': './dict_inst_all_data/inst/'}
})
...
archiv_and_change_all_instances(dict_for_instance_renaming, new_dict_for_inst_separation, tuple_list_of_named_inst,
                                tuple_list_of_non_named_inst)
time_4 = time.process_time()
print('Time for segmenting', time_4-time_3)

with emmo:
    hasSimulation = types.new_class('hasSimulation', (owlready2.ObjectProperty,))
    hasSimulation.prefLabel = [owlready2.locstr('hasSimulation', lang='en')]
    isSimulationOf = types.new_class('isSimulationOf', (owlready2.ObjectProperty,))
    isSimulationOf.prefLabel = [owlready2.locstr('isSimulationOf', lang='en')]
    # hasSimulation.inverse_property = isSimulationOf
    hasIndividual = types.new_class('hasIndividual', (owlready2.ObjectProperty,))
    hasIndividual.prefLabel = [owlready2.locstr('hasIndividual', lang='en')]
    isIndividualOf = types.new_class('isIndividualOf', (owlready2.ObjectProperty,))
    hasIndividual.inverse_property = isIndividualOf
    hasDefinedIndividual = types.new_class('hasDefinedIndividual', (owlready2.ObjectProperty,))
    hasDefinedIndividual.prefLabel = [owlready2.locstr('hasDefinedIndividual', lang='en')]
    isDefinedIndividualOf = types.new_class('isDefinedIndividualOf', (owlready2.ObjectProperty,))
    hasDefinedIndividual.inverse_property = isDefinedIndividualOf
    hasSetting = types.new_class('hasSetting', (owlready2.ObjectProperty,))
    hasSetting.prefLabel = [owlready2.locstr('hasSetting', lang='en')]
    hasOption = types.new_class('hasOption', (owlready2.DataProperty,))

basic_path_for_instances = 'C:/Users/hendr/Documents/GitHub/Hendrik_Borgelt_Masterthesis/dict_inst_all_data/'


for i in dict_for_instance_renaming:
    emmo = search_instance_folder_and_insert_into_emmo(basic_path_for_instances + i, dict_of_excel_translator,
                                                       tuple_list_of_named_inst, tuple_list_of_non_named_inst, emmo)
    print(f'Finished: {basic_path_for_instances + i}')
...
emmo.save(os.path.join('C:/Users/hendr/Documents/GitHub/Hendrik_Borgelt_Masterthesis',
                       'emmo_inferred_20220216_trying_classes_all_data.owl'))



print('Finished')
print('Time for mapping', time.process_time()-time_4)

time_5 = time.process_time()
KPIS, emmo = create_add_and_save_KPIs_in_ontology_and_images(all_sims, emmo)
print('KPI implementation time', time.process_time()-time_5)

...
Substrate_Name = 'ABTSred'
Reactant_Water = 'Water'
Reactant_Oxy = 'Oxygen'


Laccase = JSONfile(Protein_Name)
ABTSred = JSONfile(Substrate_Name)
ABTSox = JSONfile(Reactant_Name)
Water = DWSIMCompound(Reactant_Water)
Oxygen = DWSIMCompound(Reactant_Oxy)
...
Laccase.hasMolecularWeight.append(8.9026e-21) #g/mol

ABTSred.hasDWSIM_ID.append(10000)
ABTSred.hasCAS_Number.append('28752-68-3')
ABTSred.hasSMILES.append('CCN1\\C(SC2=C1C=CC(=C2)[S]([O-])(=O)=O)=N\\N=C4/SC3=C(C=CC(=C3)[S]([O-])(=O)=O)N4CC')
ABTSred.hasFormula.append('C18H18N4O6S4')
ABTSred.hasMolecularWeight.append(514.619) #g/mol

ABTSox.hasDWSIM_ID.append(20000)
ABTSox.hasCAS_Number.append('28752-68-3')
ABTSox.hasSMILES.append('CC[N+]1\\C(SC2=C1C=CC(=C2)[S]([O-])(=O)=O)=N\\N=C4/SC3=C(C=CC(=C3)[S]([O-])(=O)=O)N4CC')
ABTSox.hasFormula.append('C18H17N4O6S4')
ABTSox.hasMolecularWeight.append(515.619) #g/mol
...
ABTSred.hasWaterSolubilityValue.append(20.0)
ABTSred.hasWaterSolubilityValueUnit.append('g/l')

Laccase.isBlackOil.append(False)
ABTSred.isBlackOil.append(False)
ABTSox.isBlackOil.append(False)

Laccase.isCoolPropSupported.append(False)
ABTSred.isCoolPropSupported.append(False)
ABTSox.isCoolPropSupported.append(False)

Laccase.isF_PropsSupported.append(False)
ABTSred.isF_PropsSupported.append(False)
ABTSox.isF_PropsSupported.append(False)

Laccase.isHydratedSalt.append(False)
ABTSred.isHydratedSalt.append(False)
ABTSox.isHydratedSalt.append(False)

Laccase.isIon.append(False)
ABTSred.isIon.append(False)
ABTSox.isIon.append(False)

Laccase.isModified.append(False)
ABTSred.isModified.append(False)
ABTSox.isModified.append(False)

Laccase.isSalt.append(False)
ABTSred.isSalt.append(False)
ABTSox.isSalt.append(False)

Laccase.isSolid.append(False)
ABTSred.isSolid.append(False)
ABTSox.isSolid.append(False)
...
# optimum range depends on substrate 
    ...
    class hasTempOptimun(onto.search_one(iri = '*SBO_0000460') >> str): pass

Laccase = Oxidoreductase(protein.name)
# Subtrate = SBO_0000015, subclass of 'participant role'
ABTSred = (onto.search_one(iri = '*SBO_0000015'))('ABTSred')
# Product = SBO_0000011, subclass of 'participant role'
ABTSox = (onto.search_one(iri = '*SBO_0000011'))('ABTSox')
...
Laccase.hasTempOptimun.append('35-55 °C with ABTS as substrate')

Laccase.hasStoichometricCoeff.append(-1.0)
stoichL = Laccase.hasStoichometricCoeff

ABTSred.hasStoichometricCoeff.append(-4.0)
stoichAR = ABTSred.hasStoichometricCoeff

ABTSox.hasStoichometricCoeff.append(4.0)
stoichAO = ABTSox.hasStoichometricCoeff
...
ABTSred.hasDirectOrderCoeff.append(0.0)
DorderAR = ABTSred.hasDirectOrderCoeff

ABTSox.hasDirectOrderCoeff.append(1.0)
DorderAO = ABTSox.hasDirectOrderCoeff
...
ABTSred.hasReverseOrderCoeff.append(0.0)
RorderAR = ABTSred.hasReverseOrderCoeff

ABTSox.hasReverseOrderCoeff.append(0.0)
RorderAO = ABTSox.hasReverseOrderCoeff
...
Km_ABTSox = Km('Km_ABTSox')
kcat_ABTSox = kcat('kcat_ABTSox')

Km_ABTSox.hasKmValue.append(0.2)
Km_ABTSox.hasKmUnit.append('mmol/l')

kcat_ABTSox.has_kcatValue.append(1.67)
kcat_ABTSox.has_kcatUnit.append('1/s')
...
Laccase = p1(Protein_Name)
ABTSred = s3(Substrate_Name)
ABTSox = s5(Reactant_Name)
Oxygen = s4(Reactant_Oxy)
...
InletABTSred = (onto.search_one(iri = '*ChemicalMaterialInput_Manual'))('InletABTSred')
...
InletABTSred.hasCompoundMolarFlow.append(0.08083) # mol/s
...
onto.save("04_OntoChemSBO_myOnto.owl")
...
fileNameToSave = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), 
                              "06_ABTS Oxidation plus Onto.dwxmz")
...
imgPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "06_ABTS Oxidation.png")
